...
PACKAGE_NAME = 'stream-anywhere'
PACKAGE_DOWNLOAD_URL = 'https://github.com/Nekmo/stream-anywhere/archive/master.zip'  # .tar.gz
URL = 'https://github.com/Nekmo/stream-anywhere'
STATUS_LEVEL = 5  # 1:Planning 2:Pre-Alpha 3:Alpha 4:Beta 5:Production/Stable 6:Mature 7:Inactive
KEYWORDS = ['stream-anywhere', 'video', 'stream', 'play']

...
# PATHS
# ------------------------------------------------------------------------------
LOGS_DIRECTORY = '/var/log/stream-anywhere'
...
SITE_ID = 1
WSGI_APPLICATION = 'stream_anywhere.wsgi.application'
ROOT_URLCONF = 'stream_anywhere.urls'
ALLOWED_HOSTS = []
...
ADMINS = [("""Nekmo""", "contacto@nekmo.com")]
